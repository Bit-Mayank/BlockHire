...
function JobPost() {
    ...
    return (
        <div className="min-h-screen bg-gray-700 w-full flex justify-center items-start py-20">
            <div className="w-11/12 md:w-7/12 bg-white flex flex-col items-center p-6 rounded-2xl shadow-lg">
                {/* Heading */}
